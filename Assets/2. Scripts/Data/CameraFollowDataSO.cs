...
public class CameraFollowDataSO : ScriptableObject
{
    ...
    [field: SerializeField] public Vector3 offset { get; private set; } = new Vector3(0f, 0f, -10f);
    ...
    [field: SerializeField] public Vector3 fixedRotationAngles { get; private set; } = new Vector3(45f, 45f, 0f);
}
